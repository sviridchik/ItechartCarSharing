...
from cars_app.models import ViewedCars
req_test_health = {}
...
#
# # # ++++++++++++++++++++++ price +++++++++++++++++++++++++++++++++++++++++++++++
# # class_car Price_post_test(APITestCase):
# #
# #     def setUp(self):
# #         self.user = self.client.post('/users/signup',
# #                                      data={'username': 'test123', 'password': 'test123123', "dtp_times": 9,
...
# #
# # #
# # class_car Price_get_test(APITestCase):
# #
# #     def setUp(self):
# #         self.user = self.client.post('/users/signup',
# #                                      data={'username': 'test123', 'password': 'test123123', "dtp_times": 9,
...
# #
# # #
# # class_car Price_get_test_pk(APITestCase):
# #
# #     def setUp(self):
# #         self.user = self.client.post('/users/signup',
# #                                      data={'username': 'test123', 'password': 'test123123', "dtp_times": 9,
...
# #
# #
# # class_car Price_patch_test_pk(APITestCase):
# #
# #     def setUp(self):
# #         self.user = self.client.post('/users/signup',
# #                                      data={'username': 'test123', 'password': 'test123123', "dtp_times": 9,
...
# #
# #
# # class_car Price_delete_test_pk(APITestCase):
# #
# #     def setUp(self):
# #         self.user = self.client.post('/users/signup',
# #                                      data={'username': 'test123', 'password': 'test123123', "dtp_times": 9,
...
#
#
# class Trip_start_test(APITestCase):
#     payload_car = {
#         "level_consumption": 2,
#         "mark": "Mercedes-Benz",
#         "reg_number": "MP31523",
